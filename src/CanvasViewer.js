angular.module('CanvasViewer',[]).directive('canvasViewer', ['$window', '$http', '$timeout', '$q', function($window, $http, $timeout, $q){
	...
	return {
		...
		template: '<div class="viewer-container"><canvas class="viewer" '+
				...
				'<div class="btn btn-info" ng-click="options.controls.numPage=options.controls.numPage-1" ng-hide="options.controls.totalPage==1" title="Previous Image"><i class="fa fa-minus"></i></div>'+
				'<div class="btn btn-info" ng-hide="options.controls.totalPage==1">{{options.controls.numPage}}/{{options.controls.totalPage}}</div>'+
				'<div class="btn btn-info" ng-click="options.controls.numPage=options.controls.numPage+1" ng-hide="options.controls.totalPage==1" title="Next Image"><i class="fa fa-plus"></i></div>'+				
				'<div class="btn btn-info" ng-click="resizeTo(\'page\')" title="Reset"><i class="fa fa-file-o"></i></div>'+
				'<div class="btn btn-info" ng-click="rotate(-1)" ng-hide="options.controls.disableRotate" title="Rotate Left"><i class="fa fa-rotate-left"></i></div>'+
				'<div class="btn btn-info" ng-click="rotate(1)" ng-hide="options.controls.disableRotate" title="Rotate Right"><i class="fa fa-rotate-right"></i></div>'+
				'<div class="btn btn-info" ng-click="zoom(-1)" ng-hide="options.controls.disableZoom" title="Zoom Out"><i class="fa fa-search-minus"></i></div>'+
				'<div class="btn btn-info" ng-click="zoom(1)" ng-hide="options.controls.disableZoom" title="Zoom In"><i class="fa fa-search-plus"></i></div></div>'+
